...
const articles = defineCollection({
  ...
  schema: z.object({
    ...
    videoId: z.string().regex(/^[A-Za-z0-9_-]{11}$/).optional(), videoSrc: z.string().optional(), videoTitle: z.string().optional(), videoEyebrow: z.string().optional(), videoCopy: z.string().optional(),
