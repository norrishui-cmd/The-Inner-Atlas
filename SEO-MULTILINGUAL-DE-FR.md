...
- 12 German pages under `/de/`.
- 12 French pages under `/fr/`.
...
- Page-specific language switcher destinations instead of generic homepage redirects.
...
- Static build: 151 pages.
- German pages: 12.
- French pages: 12.
- XML sitemap URLs: 148 after the existing privacy, terms, feed and 404 filters.
